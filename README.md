# hot-noodle
We built an IoT WiFi-enabled smart pool monitor that texts you to alert you of different features (e.g. hot tub temperature)! It can float aimlessly or move around on its own with a 3D-printed propeller! Built as part of a hackathon project at HackUMass VI and winner of the MLH DragonBoard competition!
